...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "RikiiRecetas.dll" comes first in this list. */
		"RikiiRecetas.dll",
		"cl.Common.RikiiRecetas.Models.dll",
		"cl.Common.RikiiRecetas.Service.dll",
		"cl.Common.RikiiRecetas.Utils.dll",
		"Lottie.Android.dll",
		"Newtonsoft.Json.dll",
